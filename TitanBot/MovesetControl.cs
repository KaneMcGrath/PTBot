...
namespace StinkMod
{
    ...
    public static class MovesetControl
    {
        ...
        public static void SetDefaults()
        {
            ...
            movesetControlDatabase.Add(PTAction.grab_head_front_l, new TitanMove("Grab Face Right", "head_front_l", true, 0f, -1f, 0f));
            movesetControlDatabase.Add(PTAction.grab_head_front_r, new TitanMove("Grab Face Left", "head_front_r", true, 0f, -1f, 0f));
        }
    }
